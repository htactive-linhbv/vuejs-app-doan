  ...
  <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
      <a class="navbar-brand brand-logo">
        <img src="/assets/images/logo/logo-1.png" style="height: 80px;" alt="logo" />
      </a>
      <a class="navbar-brand brand-logo-mini">
        <img
          src="/assets/images/logo/logo-mini-1.png"
    ...
    <div class="navbar-menu-wrapper d-flex align-items-stretch">
      ...
      <ul class="navbar-nav navbar-nav-right">
        <li class="nav-item nav-profile dropdown">
          ...
          >
            <div class="nav-profile-img">
              <img src="/assets/images/faces/avatar.png" alt="image" />
          ...
          <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
            <router-link class="dropdown-item" to="/quantri/taikhoan">
              <i class="mdi mdi-cached mr-2 text-success"></i> Cài đặt tài khoản
            </router-link>
        ...
        <li class="nav-item nav-settings d-none d-lg-block" @click.prevent="full()">
          <a class="nav-link">
